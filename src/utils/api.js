...
export function getBoardData({ board = 'top250', page = 1, count = 10, city = '福州', search = '' } = {}) {
    let params = {}
    if (board !== 'us_box') {
    ...
    return request({ method: 'GET', data: { ...params }, url: `/${board}?apikey=0df993c66c0c636e29ecbb5344252a4a` })
}
...
export function getMovieData(id) {
    return request({ method: 'GET', data: {}, url: `/subject/${id}?apikey=0df993c66c0c636e29ecbb5344252a4a` })
}
